# Zshrc Template for Terminal Setup
resource "null_resource" "zshrc_template" {
  provisioner "local-exec" {
    command = <<EOT
      echo "🔧 Applying Zsh configuration template..."

      # Write the Zsh configuration template to the specified user config path
      cat <<'EOF' > ~/.zshrc
